/**
 * One-time migration: rename physical_preset keys for the two emotion-management
 * presets that were renamed in June 2026:
 *   positive_emotion → stress_relief
 *   mindfulness      → sleep_rest
 *
 * Safe to re-run — only updates docs where physical_preset matches the old key.
 *
 * Usage (from frontend/):
 *   node scripts/migrate-rename-emotion-presets.mjs
 */
...
const RENAMES = [
  { from: "positive_emotion", to: "stress_relief" },
  { from: "mindfulness",      to: "sleep_rest" },
];
