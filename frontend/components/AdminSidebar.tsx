...
const NAV_ICONS: Record<string, React.ReactNode> = {
  Dashboard: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={{ width: "1em", height: "1em", flexShrink: 0 }}>
  ...
  return (
    <>
      ...
      <div className="admin-topbar">
        ...
        >
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" style={{ width: "1.2rem", height: "1.2rem" }}>
      ...
      <aside className={`admin-sidebar${open ? " open" : ""}`} aria-label="Admin navigation">
        ...
        <div className="admin-sidebar-brand" style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" style={{ width: "1rem", height: "1rem" }}>
