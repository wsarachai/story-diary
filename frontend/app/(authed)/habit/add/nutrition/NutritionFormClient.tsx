...
interface NutritionFormClientProps {
  preset?: NutritionPresetKey;
}

export default function NutritionFormClient({
  preset,
}: NutritionFormClientProps) {
  ...
  function handleCancel() {
    ...
    router.push(`/habit/add/nutrition?from=${from}`);
  }
              ...
              <div className={styles.formPanel}>
                <div className={styles.nameRow}>
                  <input
                    ...
                    value={form.name}
                    readOnly={hasLockedNutritionPreset}
                    onChange={(e) =>
                      dispatchForm({
                        type: "SET_NAME",
