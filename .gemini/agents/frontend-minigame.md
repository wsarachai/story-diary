...
description: Implements Story Diary minigame quiz flow (s007, s017–s019, s031). Owns quizSlice with in-flight attempt state machine.
tools:
  - list_directory
  - read_file
  - write_file
...
**Memory file**: `.gemini/memory/frontend-minigame/progress.md`

**On every startup — do this first**:
1. Try to read `.gemini/memory/frontend-minigame/progress.md`.
