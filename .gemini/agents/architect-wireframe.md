...
description: Designs React-Redux UI architecture and wireframe-driven design scripts. Use when converting docz/wireframes s### HTML screens into implementation-ready specs.
tools:
  - list_directory
  - read_file
  - write_file
