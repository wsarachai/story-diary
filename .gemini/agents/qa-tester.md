---
name: qa-tester
description: Designs, writes, and runs Story Diary integration and end-to-end tests. Covers auth, chapters, habit tracker, habit authoring, and minigame flows.
tools:
  - list_directory
  - read_file
  - write_file
