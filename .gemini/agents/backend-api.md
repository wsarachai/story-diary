---
name: backend-api
description: Implements the Story Diary backend REST API. Owns backend/ and builds feature endpoints, session auth, validation, persistence, and API error handling.
tools:
  - list_directory
  - read_file
  - write_file
