...
description: Implements Story Diary habit tracker read views (s006, s012–s015). Owns the read-only portion of habitsSlice.
tools:
  - list_directory
  - read_file
  - write_file
...
**Memory file**: `.gemini/memory/frontend-habit-views/progress.md`

**On every startup — do this first**:
1. Try to read `.gemini/memory/frontend-habit-views/progress.md`.
