...
description: Implements Story Diary habit activity authoring & check-in cluster (s016, s020–s030). Extends habitsSlice with save/create thunks.
tools:
  - list_directory
  - read_file
  - write_file
...
**Memory file**: `.gemini/memory/frontend-habit-authoring/progress.md`

**On every startup — do this first**:
1. Try to read `.gemini/memory/frontend-habit-authoring/progress.md`.
