...
**Memory file**: `.gemini/memory/frontend-builder/progress.md`

**On every startup — do this first**:
1. Read `.gemini/memory/frontend-builder/progress.md`.
2. Also read each feature agent's memory file to understand what has already been built:
   - `.gemini/memory/frontend-auth/progress.md`
   - `.gemini/memory/frontend-chapters/progress.md`
   - `.gemini/memory/frontend-habit-views/progress.md`
   - `.gemini/memory/frontend-minigame/progress.md`
   - `.gemini/memory/frontend-habit-authoring/progress.md`
3. Use this to understand the overall build state before routing any work.

**After delegating work or making cross-feature decisions**: update `.gemini/memory/frontend-builder/progress.md`:
