 ...
 */
export type PhysicalCategory = "emotion-management" | "exercise" | "sunlight" | "infection" | "symptoms" | "doctor-visit" | "pregnancy-planning" | "other";
/**
 ...
 */
export type NutritionPresetKey = "nutrition_5_groups" | "nutrition_clean_cooked" | "nutrition_mild_taste" | "nutrition_order_low_seasoning";
/** Display map for the s021 picklist. The wireframe is the source of truth. */
export declare const NUTRITION_PRESETS: Readonly<Record<NutritionPresetKey, string>>;
