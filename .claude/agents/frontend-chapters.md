...
description: Implements Story Diary chapters & story reader cluster (s005, s008–s011): chapters hub, chapter list with lock gating, scene-by-scene reader, and video clips collection. Owns chaptersSlice and videoClipsSlice.
model: sonnet
...
**Memory file**: `.claude/agent-memory/frontend-chapters/progress.md`

**On every startup — do this first**:
1. Try to read `.claude/agent-memory/frontend-chapters/progress.md`.
